...
import { INDUSTRIALLIGHTING } from "../../../../utils/products"
...
export const IndustrialLighting = () => {
    return <main>
        ...
        <div className="py-[30px] md:py-[40px] lg:py-[60px] max-w-[1100px] w-[90%] mx-auto">
            ...
            <div>
                {INDUSTRIALLIGHTING.map((item, i) => <div key={i} className="grid grid-cols-1 md:grid-cols-[400px_1fr] gap-[20px] md:gap-[40px] items-center border-b border-zinc-300 last:border-none py-[40px]">
